        ...
        for epoch in range(1, self.max_iter + 1):
            ...
            while bidx < n_batchs:
                ...
                if gen_iterations % self.eval_freq == 0:
                    ...
                    val_dict = valid_epoch(self.Data, self.Data.val_set, netD, self.batch_size, Y_val, L_val)
                    tst_dict = valid_epoch(self.Data, self.Data.tst_set, netD, self.batch_size, Y_tst, L_tst)
