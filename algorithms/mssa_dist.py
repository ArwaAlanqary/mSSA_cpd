...
class mssa_dist: 
    ...
    def __init__(self, window_size = 200, rows= 30, rank=None, distance_threshold = 10, 
                 training_ratio= .5, skip = True, normalize = True):
        self.rows = rows
    ...
    def detect(self, ts):
        ...
        while t <= len(current_ts)-step:
            ...
            test_vector = current_ts[t-self.rows:t, :]
